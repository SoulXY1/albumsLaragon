...
<body>
    ...
    <h1 class="container mt-5">Crear Género</h1>
    <form method="POST" action="/genre" id="formulario" class="container">
        @csrf

        <div class="form-group mt-3">
            <label for="genreName">Nombre del Género</label>
            <input id="genreName" type="text" name="genreName" class="form-control">
        </div>
        <div class="form-group mt-3">
            <label for="decade">Decada Aprox</label>
            <input id="decade" type="text" name="decade" class="form-control">
        </div>
        <div class="form-group mt-3">
